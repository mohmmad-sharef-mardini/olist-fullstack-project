...
GO
-- ----------------------------------------------------------
-- 1.1  Create olist_customers_dataset table 
-- ----------------------------------------------------------

IF OBJECT_ID('raw_ecomm.olist_customers_dataset', 'U') IS NULL
CREATE TABLE raw_ecomm.olist_customers_dataset (
...
-- ----------------------------------------------------------
-- 1.2  Create olist_geolocation_dataset table 
-- ----------------------------------------------------------

IF OBJECT_ID('raw_ecomm.olist_geolocation_dataset','U') IS NULL
CREATE TABLE raw_ecomm.olist_geolocation_dataset(
...
-- ----------------------------------------------------------
-- 1.3  Create olist_order_items_dataset table 
-- ----------------------------------------------------------

IF OBJECT_ID('raw_ecomm.olist_order_items_dataset','U') IS NULL

CREATE TABLE raw_ecomm.olist_order_items_dataset(
...
-- ----------------------------------------------------------
-- 1.4  Create olist_order_payments_dataset 
-- ----------------------------------------------------------

IF OBJECT_ID('raw_ecomm.olist_order_payments_dataset','U') IS NULL 

CREATE TABLE raw_ecomm.olist_order_payments_dataset(
...
-- ----------------------------------------------------------
-- 1.5  Create olist_order_reviews_dataset
-- ----------------------------------------------------------

IF OBJECT_ID('raw_ecomm.olist_order_reviews_dataset','U') IS NULL 

CREATE TABLE raw_ecomm.olist_order_reviews_dataset(
...
-- ----------------------------------------------------------
-- 1.6  Create olist_orders_dataset
-- ----------------------------------------------------------

IF OBJECT_ID('raw_ecomm.olist_orders_dataset','U') IS NULL 
CREATE TABLE raw_ecomm.olist_orders_dataset(
	order_id						NVARCHAR(50),
...
GO
-- ----------------------------------------------------------
-- 1.7  Create olist_products_dataset
-- ----------------------------------------------------------

IF OBJECT_ID('raw_ecomm.olist_products_dataset','U') IS NULL 
CREATE TABLE raw_ecomm.olist_products_dataset(
	product_id						NVARCHAR(50),
...
-- ----------------------------------------------------------
-- 1.8  Create olist_sellers_dataset
-- ----------------------------------------------------------

IF OBJECT_ID('raw_ecomm.olist_sellers_dataset','U') IS NULL 

CREATE TABLE raw_ecomm.olist_sellers_dataset(
...
-- ----------------------------------------------------------
-- 1.9  Create product_category_name_translation
-- ----------------------------------------------------------

IF OBJECT_ID('raw_ecomm.product_category_name_translation','U') IS NULL 

CREATE TABLE raw_ecomm.product_category_name_translation(
